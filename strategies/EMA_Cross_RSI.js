...
var strat = {
	...
	init: function () {
		...
		this.prev_stop_price = undefined;
	...
	check: function (candle) {
		...
		const is_sideway_market = rsi <= this.settings.RSI_high && rsi >= this.settings.RSI_low;
		...
		if (entry_price && price <= stop_price) {
			// console.log("Reach Stop: ", candle.close);
			this.short(candle);
		}
